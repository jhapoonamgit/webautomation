...
public class CreateCustomFieldsEnterpriseTest extends BaseTest {
	...
	@Test
	public void createCustomFieldsForEnterpriseLead() {
		String dataType, label, name, description;

		XSSFSheet sheet = null;
		List<String> lstStatus = new ArrayList<String>();

		new SalesforceCustomFields(driver).login(prop.getProperty("username_enterprise"),
				prop.getProperty("password_enterprise"));
